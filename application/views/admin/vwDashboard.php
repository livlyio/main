    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <ul style="max-width: 260px;" class="nav nav-pills nav-stacked">
                <li class="active">
                    <a href="#">
                        <span class="badge pull-right"><?php echo $total_links; ?></span>
                        Total Links
                    </a>
                </li>
                <li><a href="#">Porn
                        <span class="badge pull-right"><?php echo $total_porn; ?></span></a>
                </li>
                <li>
                    <a href="#">
                        <span class="badge pull-right"><?php echo $total_weight; ?></span>
                        Weightloss
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="badge pull-right"><?php echo $total_test; ?></span>
                        Test
                    </a>
                </li>
            </ul>
